...
class MessageHistory {
  final String? msgID; // Auto-generated by Firestore
  ...
  MessageHistory({
    this.msgID, // Firestore generates this
  ...
  factory MessageHistory.fromMap(String id, Map<String, dynamic> map) {
...
Future<void> logCall(MessageHistory call) async {
  ...
  try {
    DocumentReference docRef = await firestore.collection("MessageHistory").add(call.toMap());
...
void logEmergencyCall() async {
  MessageHistory call = MessageHistory(
